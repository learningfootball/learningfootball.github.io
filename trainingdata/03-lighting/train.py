...
# train your network
n_epochs = 1000 # 500 # start small, and increase when you've decided on your model structure and hyperparams


dotrain = input("Train data set (y) or load existing data set (n)?")
...
if dotrain=='n':
    ...
    model_name = 'keypoints_model_adam_SmoothL1_50_batchsize_'+str(n_epochs)+'_epochs_12800_6400_1000_dense.pt'
